...
This file exists at the root level for Streamlit Cloud compatibility.
It imports and runs the actual app from apps/exam_prep_master.py
"""
...
# Now run the master app code
# (copy of exam_prep_master.py content)
"""
